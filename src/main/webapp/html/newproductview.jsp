...
<html lang="en">
    <head>
        ...
        <title>LucVs Stu. | New Items</title>
...
<body>
    ...
    <header>
        <div class="navbar">
            ...
            <ul class="links">
                ...
                <li><a href="ToNewProduct" style="color: black;">New Products</a> </li>
    ...
    <section class="products">
        <section class="baner" style="background-image: url('img/banner2.png');">
        </section>
        <h1>New products</h1>
