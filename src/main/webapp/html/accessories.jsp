...
<html lang="en">
    <head>
        ...
        <title>LucVs Stu. | Accessories</title>
...
<body>
    ...
    <header>
        <div class="navbar">
            ...
            <ul class="links">
                ...
                <li><a href="accessories.html" style="color: black;">Accessories</a> </li>
            </ul>
            ...
            <ul>
                ...
                <li><a href="GetTopsProduct">Tops</a> </li>
                <li><a href="ToBottomProduct">Bottom</a> </li>
                <li><a href="ToAccessories" style="color: black;">Accessories</a> </li>
    ...
    <section class="products">
        <section class="baner" style="background-image: url('img/banner6.png');">
        </section>
        <h1>Accessories</h1>
