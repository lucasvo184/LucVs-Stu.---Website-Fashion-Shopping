...
<html lang="en">
    <head>
        ...
        <title>LucVs Stu. | Tất cả sản phẩm</title>
...
<body>
    <header>
        <div class="navbar">
            ...
            <ul class="links">
                <li><a href="ToAllProduct" style="color: black;">All Products</a> </li>
    ...
    <section class="products">
        <section class="baner" style="background-image: url('img/banner3.png');">
        </section>
        <h1>All products</h1>
